...
import { setCurrentPlayerTrack, switchPlayerStatus, openModal } from '../../utils/redux/_actions';

import AlbumTrackModal from '../_modals/albumTrackModal/AlbumTrackModal';
import { Link } from 'react-router-dom'
import { ROUTES } from '../../utils/router/routes';

import './albumItem.scss'

const AlbumItem = ({num, id, name, thumbnail, artist, audio, type}) => {
    ...
    const playTrack = (id) => {
        ...
        if(currentTrackId === id) {
            dispatch(switchPlayerStatus({isPlaying: !isPlaying, isTheSamePlaing: !isTheSamePlaing}))  
        } else {
            dispatch(switchPlayerStatus({player: true, isPlaying: true, currentTrackId: id, isTheSamePlaing: true}))
            dispatch(setCurrentPlayerTrack({name, artist, thumbnail, audio}))
        }  
    }
